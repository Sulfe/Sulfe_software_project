...
function onSelectChange() {
  ...
  if (selected.val() == 00) {
    ...
    output = '<div class="q_sel"> <input class="q_select" type="radio" readonly /><input class="q_selOption" type="text" placeholder="옵션" /></div>';
    $('.q_selDel').show();
    $('.q_selAdd').show();
    $('.q_selDel').attr("onclick","selDelBtn();")
    $('.q_selAdd').attr("onclick","selAddBtn();")
  } else {
    output = '<div class="q_che"> <input type="checkbox" class="q_check" readonly /><input type="text" class="q_cheOption" placeholder="옵션" /></div>';
    $('.q_selDel').show();
    $('.q_selAdd').show();
...
var sel = '<div class="q_sel"><input class="q_select" type="radio" readonly /><input class="q_selOption" type="text" placeholder="옵션" /></div>';
